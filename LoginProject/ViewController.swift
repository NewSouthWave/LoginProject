...
// MARK: - 코드 스니팻으로 미리 코드 자동완성 포맷을 만들 수 있다
...
final class ViewController: UIViewController {
    ...
    private let passwordSecureButton: UIButton = {
        ...
        button.setTitleColor((UIColor(red: 0.837418098, green: 0.8374378085, blue: 0.8374271393, alpha: 1)), for: .normal)
...
//        passwordInfoLabel.centerYAnchor.constraint(equalTo: passwordTextFieldView.centerYAnchor).isActive = true
    ...
    @objc func passwordSecureModeSetting() {
        passwordTextField.isSecureTextEntry.toggle()    //  toggle 메서드를 사용하면 true false가 자동전환된다 -> bool형에 상속된 메서드
...
extension ViewController: UITextFieldDelegate { //  delegate 패턴을 만들 때 따로 확장하여 분리
